...
1. ✓ Address is correct and active
2. ✓ Source documentation is legitimate
3. ✓ Entry follows our privacy-focused guidelines
4. ✓ No malicious or misleading information
...
Open an issue if you're unsure whether an address should be included.
