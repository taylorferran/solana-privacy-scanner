...
- **Below 50%**: Low confidence (uncertain pattern)
...
See [Known Entities](/docs/reports/known-entities) for the full list.
...
- **[Risk Levels](/docs/reports/risk-levels)** - Deep dive into risk scoring
- **[Heuristics](/docs/reports/heuristics)** - Detailed heuristic explanations
- **[CLI Usage](/docs/cli/quickstart)** - Start scanning
