...
| Below 40% | Very low confidence - uncertain |
...
- **[Heuristics](/docs/reports/heuristics)** - Understanding each detection method
- **[Known Entities](/docs/reports/known-entities)** - Database of tracked addresses
- **[CLI Examples](/docs/cli/examples)** - See real scans
