...
import { RPCClient, collectProgramData, normalizeProgramData, generateReport, createDefaultLabelProvider, } from '@solana-privacy-scanner/core';
import { formatReport } from '../formatter.js';
export async function scanProgram(programId, options) {
    try {
        // Validate RPC URL
        if (!options.rpc) {
