 ...
 */
export function normalizeWalletData(rawData, labelProvider) {
    const allTransfers = [];
 ...
 */
export function normalizeTransactionData(rawData, labelProvider) {
    const allTransfers = [];
    const allInstructions = [];
    const counterparties = new Set();
 ...
 */
export function normalizeProgramData(rawData, labelProvider) {
    const allTransfers = [];
    const allInstructions = [];
    const counterparties = new Set();
